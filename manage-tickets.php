...
echo '<script>alert("lead has been updated."); location.replace(document.referrer)</script>';
}
?>
<!DOCTYPE html>
<html>
  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">View Leads</a></li>
      </ul>
        ...
        <div class="col-md-12">
          <div class="grid simple no-border">
            <div class="grid-title no-border descriptive clickable">
              ...
              <p ><span class="text-success bold">Lead #<?php echo $_SESSION['sid']=$row['ticket_id'];?></span> - Created on <?php echo $row['posting_date'];?>
